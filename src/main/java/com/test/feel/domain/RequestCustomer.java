...
@Entity
@ApiModel(description = "Customer of the request")
@Validated
public class RequestCustomer {
	...
	@Id
	  ...
	  public RequestCustomer id(String id) {
	    this.id = id;
	    return this;
	  }
	...
	public RequestCustomer name(String name) {
	    this.name = name;
	    return this;
	}
	 ...
	 * @return the name
	 */
	@ApiModelProperty(readOnly = true, value = "Customer name")
	...
	public String toString() {
		return "RequestCustomer [id=" + id + ", name=" + name + "]";
	}
